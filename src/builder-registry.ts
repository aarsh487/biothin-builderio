...
import { RegistryBanner } from "./components/HomePage/Hero";
import { BundleTeaser } from "./components/HomePage/Bundle";
import { ProblemBlock } from "./components/HomePage/ProblemBlock";
import { Testimonials } from "./components/HomePage/Testimonials";
import { ProductTeaser } from "./components/HomePage/ProductTeaser";
import { AssortmentTeaser } from "./components/HomePage/AssortmentTeaser";
import CommunityHero from "./components/Posts/CommunityHero";
import RichTextBlock from "./components/Posts/RichTextBlock";
import ContactForm from "./components/Posts/ContactForm";
  ...
  inputs: [
    {
      name: "label",
      type: "text",
      defaultValue: "Bedürfnisse sind verschieden",
    },
    {
      name: "headline",
      type: "text",
      defaultValue:
        "KANN MIR BIO-H-TIN BEI MEINEN HAAR- UND NAGEL-PROBLEMEN HELFEN?",
    },
  ...
  inputs: [
    {
      ...
      type: "text",
      defaultValue:
        "DAS BEHANDLUNGS-SYSTEM FÜR NACHHALTIG GESUNDE HAARE UND NÄGEL.",
    },
    { name: "headlineColor", type: "color", defaultValue: "#F59E0B" },
    ...
    { name: "ctaTextColor", type: "color", defaultValue: "#FFFFFF" },
    {
      name: "productImage",
      type: "file",
      allowedFileTypes: ["png", "webp", "jpeg"],
    },
  ],
});
...
Builder.registerComponent(AssortmentTeaser, {
  ...
  inputs: [
    ...
    { name: "paragraph", type: "richText" },
    {
      name: "buttonText",
      type: "text",
      defaultValue: "WIRKT VON AUSSEN + INNEN",
    },
...
Builder.registerComponent(HorizontalRule, {
